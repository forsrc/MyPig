...
INSERT INTO oauth_client_details (client_id, resource_ids, client_secret, scope, authorized_grant_types, web_server_redirect_uri, authorities, access_token_validity, refresh_token_validity, additional_information, autoapprove) VALUES  ('sso',   null,   '$2a$10$Smc1lKpNSr/MeX1ZTt0GVu0b6LzlbOBp8Lzy9JfriAb1Xp8rVBMsm', 'sso,read,write',    'authorization_code,client_credentials,refresh_token,password,implicit', null, null, 36000, 36000, null, true);
INSERT INTO oauth_client_details (client_id, resource_ids, client_secret, scope, authorized_grant_types, web_server_redirect_uri, authorities, access_token_validity, refresh_token_validity, additional_information, autoapprove) VALUES  ('tcc',   null,   '$2a$10$Smc1lKpNSr/MeX1ZTt0GVu0b6LzlbOBp8Lzy9JfriAb1Xp8rVBMsm', 'tcc,read,write',    'authorization_code,client_credentials,refresh_token,password,implicit', null, null, 36000, 36000, null, true);
INSERT INTO oauth_client_details (client_id, resource_ids, client_secret, scope, authorized_grant_types, web_server_redirect_uri, authorities, access_token_validity, refresh_token_validity, additional_information, autoapprove) VALUES  ('ui',    null,   '$2a$10$Smc1lKpNSr/MeX1ZTt0GVu0b6LzlbOBp8Lzy9JfriAb1Xp8rVBMsm', 'ui,read,write',     'authorization_code,client_credentials,refresh_token,password,implicit', null, null, 36000, 36000, null, true);
INSERT INTO oauth_client_details (client_id, resource_ids, client_secret, scope, authorized_grant_types, web_server_redirect_uri, authorities, access_token_validity, refresh_token_validity, additional_information, autoapprove) VALUES  ('user',  null,   '$2a$10$Smc1lKpNSr/MeX1ZTt0GVu0b6LzlbOBp8Lzy9JfriAb1Xp8rVBMsm', 'user,read,write',   'authorization_code,client_credentials,refresh_token,password,implicit', null, null, 36000, 36000, null, true);
...
-- authorities
INSERT INTO authorities (username, authority) SELECT * FROM (SELECT 'forsrc@gmail.com' username, 'ROLE_ADMIN' authorities) AS T WHERE NOT EXISTS (SELECT username FROM authorities WHERE username = 'forsrc@gmail.com');
INSERT INTO authorities (username, authority) SELECT * FROM (SELECT 'forsrc@gmail.com' username, 'ROLE_USER'  authorities) AS T WHERE NOT EXISTS (SELECT username FROM authorities WHERE username = 'forsrc@gmail.com');
...
INSERT INTO t_sso_user_tcc (id, username, "password", enabled, authorities, expire, status) SELECT * FROM (SELECT uuid_in('5112cdecfec04f2e8d364ed1d14b7882') id, 'A' username, '$2a$10$Wzme7qZtAsJZspQpNx3ee.qTu/IqRHiTb0jORWUOXCxptAkG3kf8e' "password", 1 enabled, 'ROLE_USER' authorities, (CURRENT_TIMESTAMP + '5 minute') expire, 0 status) AS T WHERE NOT EXISTS (SELECT username FROM t_sso_user_tcc WHERE id = '5112cdecfec04f2e8d364ed1d14b7882');
...
UPDATE t_sso_user_tcc SET expire = (CURRENT_TIMESTAMP + '5 minute'), status = 0 WHERE id = '5112cdecfec04f2e8d364ed1d14b7882';
